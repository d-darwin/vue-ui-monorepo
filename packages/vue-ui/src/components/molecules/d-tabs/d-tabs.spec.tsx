...
describe("DTabs", () => {
  ...
  it("Should pass props.size to props.size of containing DTab components", async () => {
    ...
    expect(tabWrapper.props("size")).toBe(size);
  });
  ...
  it("Should pass props.size to props.size of containing DTabpanel components", async () => {
    ...
    expect(tabpanel.props("size")).toBe(size);
  });
